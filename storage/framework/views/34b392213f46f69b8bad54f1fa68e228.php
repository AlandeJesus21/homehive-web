        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-4 justify-content-center">
            ...
            <div class="col">
                <div class="card h-100 text-center shadow-sm">
                    <img src="<?php echo e(asset('images/dama.png')); ?>" class="card-img-top mx-auto mt-3 rounded-circle"
            ...
            <div class="col">
                <div class="card h-100 text-center shadow-sm">
                    <img src="<?php echo e(asset('images/rosario.png')); ?>" class="card-img-top mx-auto mt-3 rounded-circle"
            ...
            <div class="col">
                <div class="card h-100 text-center shadow-sm">
                    <img src="<?php echo e(asset('images/alan.png')); ?>" class="card-img-top mx-auto mt-3 rounded-circle"
            ...
            <div class="col">
                <div class="card h-100 text-center shadow-sm">
                    <img src="<?php echo e(asset('images/eduardo.png')); ?>" class="card-img-top mx-auto mt-3 rounded-circle"
...
<?php endif; ?><?php /**PATH C:\webapps\laravel\homehive-web\resources\views/main/acerca.blade.php ENDPATH**/ ?>