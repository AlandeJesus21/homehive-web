                ...
                <div class="col-md-4 mb-4">
                    ...
                    <div class="card border-0 shadow-lg" style="border-radius: 25px; overflow: hidden;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted small mb-3">{{ $propiedad->barrio }}</p>

                            
                            <div class="row g-2">
                                <div class="col-6">
                                    <a href="{{ route('propiedades.edit', $propiedad->id) }}" class="btn btn-outline-secondary w-100 btn-sm d-flex align-items-center justify-content-center">
                                        <i class="bi bi-pencil me-1"></i> Editar
                                    </a>
                                </div>
                                <div class="col-6">
                                    
                                    <button class="btn btn-outline-secondary w-100 btn-sm d-flex align-items-center justify-content-center">
                                        <i class="bi bi-chat-dots me-1"></i> Comentarios
                                    </button>
                                </div>
                                <div class="col-6">
                                    <a href="{{ route('propiedades.show', $propiedad->id) }}" class="btn btn-outline-secondary w-100 btn-sm d-flex align-items-center justify-content-center">
                                ...
                                <div class="col-6">
                                    <form action="{{ route('propiedades.destroy', $propiedad->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-outline-danger w-100 btn-sm d-flex align-items-center justify-content-center"
