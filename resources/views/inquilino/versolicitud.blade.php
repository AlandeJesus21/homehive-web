                    ...
                    <div class="card bg-white border-0 shadow rounded-5 overflow-hidden">
                        ...
                        <div class="px-4 px-md-5 mt-4">
                            <div class="d-flex align-items-center">
                                <div class="rounded-circle bg-secondary shadow-sm"
                                    style="width: 70px; height: 70px; background-image: url('https://i.pravatar.cc/150?u=pauline'); background-size: cover;">
                                </div>

                                <div class="ms-4">

                                    <h4 class="fw-bold text-dark m-0 h4">
                                        {{ $solicitud->usuario->name ?? 'usuario no encontrado' }}</h4>
                            ...
                            <div class="row g-3 text-secondary" style="font-size: 1.1rem;">
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center mb-3">
                                        <i class="bi bi-person-bounding-box me-3"></i> <svg
                                        ...
                                        </svg>{{ $solicitud->edad }} años
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-telephone me-3"></i> <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        </svg>{{ $solicitud->telefono }}
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center mb-3">
                                        <i class="bi bi-calendar3 me-3"></i><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-person-vcard me-3"></i><svg xmlns="http://www.w3.org/2000/svg"
